...
The projection of this outlier point $`\begin{bmatrix} x_{1} & x_{2} end{bmatrix}^{T}`$ on the line passing through $`\begin{bmatrix} w_{1} & w_{2} end{bmatrix}^{T}`$ is given by:
